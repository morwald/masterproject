...
flow problems, in their original formulations, typically have \red{singular
boundary conditions} at the corners, where the velocity profile is
...
saddle-node (fold), and Hopf. \red{Predicting} the precise location of the
...
introduction to the regularized version. The necessary \red{theory} is
