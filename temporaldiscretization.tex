...
% The eigenvalues are exponentially decaying.
% We have seen that using a Chebyshev collocation method (the first N
% eigenvalues) is a good approximation, and the dispersion for a Chebyshev
% discretization is minimal compared to a finite difference approximation
% \citep{boyd2001}.
...
This means that to calculate the solution the timestep $t_{n+1}$ from a given
...
\begin{figure}[ht!]
\begin{center}
  \includegraphics[width=0.4\textwidth]{figs/64x64_asym_solutions.png}
\end{center}
