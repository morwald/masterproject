...
given boundary conditions to the vector \jlinl{u}. Though this function could
...
when writing efficient Julia code. In the optimized version, the \jlinl{struct
...
as well) and should be used carefully. Moreover, the macro \jlinl{@views}
