...
The code snippet \ref{code:f} shows a straightforward implementation of the
nonlinear function. 
...
notations for mathematical expressions. The \jlinl{constructBC(u,p)} is a
...
The \jlinl{strut} \jlinl {p} is now split into a parameter part and a cache.
