...
Upon analyzing the bifurcation diagram, it is clear that the regularized
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.3\textwidth]{figs/orbits.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.3\textwidth]{figs/orbits_bif_diag.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.3\textwidth]{figs/sub_hopf_sketch.png}
...
The emergence of the second branch uncovers a new perspective on the problem.
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.3\textwidth]{figs/sol_branch2.png}
