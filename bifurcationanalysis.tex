...
An alternative perspective on our problem at hand is the theory of dynamical
...
row of the augmented Jacobian is just given by the transpose of the distance in
phase space. The last column (without the last row) making the finite
difference derivative with respect of the nonlinear function with respect to
$\mu$. It is necessary to scale the change in $\mu$ to obtain a
